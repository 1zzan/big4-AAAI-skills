...
- For cybersecurity, APT detection, SOC/endpoint threat detection, cyber-threat analysis, LLM-agent security, MCP/tool poisoning, prompt injection, or security benchmarks, read `references/security-llm-agent-aaai-patterns.md` before judging venue fit, evidence sufficiency, or related-work positioning.
